...
const Features1 = () => {
  ...
  const {pretitle, title, subtitle, btnLink, btnIcon, image} = data.features.feature1
  ...
  return (
    <section className="section mb-12 lg:mb-0">
      <div className="container mx-auto">
        ...
        whileInView={'animate'}
        viewport={{once: true}}
        className="flex flex-col lg:flex-row items-center gap-y-12 lg:gap-y-0 lg:gap-x-[1.8rem]">
